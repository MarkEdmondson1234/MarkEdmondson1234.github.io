...
I had/have a lot of hassles with git submodules, I found this StackOverflow answer helped a lot to wipe the [slate clean of git submodules](http://stackoverflow.com/questions/20929336/git-submodule-add-a-git-directory-is-found-locally-issue) and start again with the Hugo instructions
