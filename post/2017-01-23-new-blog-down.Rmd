...
This keeps the advantages of Jekyll (static, high performance website, markdown, free hosting on Github) but with the extra bonus of being able to render in RMarkdown plus adding some nice looking capabilities from the [Hugo](https://gohugo.io/) project.
